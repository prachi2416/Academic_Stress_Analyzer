    ...
    <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-sm border border-slate-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900">Academic Subjects &amp; Deadlines</h3>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold text-xs px-4 py-2.5 rounded-xl shadow-md shadow-purple-500/20 transition cursor-pointer self-start sm:self-auto"
        >
      ...
      {subjects.length === 0 ? (
        <div className="text-center py-12 px-4 rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 reveal-on-scroll">
          ...
          <button
            onClick={handleOpenAdd}
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 px-3.5 py-1.5 rounded-lg transition btn-press cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 reveal-on-scroll">
          {subjects.map((sub) => {
            ...
            return (
              <div
                key={sub.id}
                className="relative bg-white border border-slate-200 hover:border-indigo-300 rounded-3xl p-5 sm:p-6 shadow-xs card-hover flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-2.5">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition btn-press cursor-pointer"
                        title="Edit subject"
                      ...
                      <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition btn-press cursor-pointer"
                  ...
                  <div className="my-3 pt-2.5 border-t border-slate-100">
                    ...
                    <p className="text-xs text-slate-700 bg-slate-50/80 p-2.5 rounded-xl border border-slate-100 leading-relaxed font-medium">
                      {sub.tasksRemaining}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 py-2.5 border-t border-slate-100 text-xs text-slate-600 font-medium">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-7 shadow-2xl border border-slate-200 overflow-y-auto max-h-[90vh]">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm font-semibold font-mono rounded-xl border border-slate-200"
                />
              ...
              <div className="grid grid-cols-3 gap-2.5 pt-1">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2 py-2 text-xs rounded-xl border border-slate-200 bg-white"
                  >
            ...
            <div className="flex items-center justify-end gap-2 mt-6 pt-4 border-t border-slate-100">
              ...
              <button
                type="button"
                onClick={handleSave}
                className="inline-flex items-center gap-1.5 px-5 py-2 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-md shadow-indigo-500/20 transition cursor-pointer"
              >
